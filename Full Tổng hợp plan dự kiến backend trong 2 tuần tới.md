# AI Study Hub – Backend GitHub Project Task Plan V2

> **Update V2:** Đã bổ sung Community, Review Queue, Report Moderation, Admin Content Management, Community Role Scope, System Config, Activity Log, AI Usage Analytics và các backlog ngoài ERD.
> File này được cập nhật sau khi đối chiếu lại ERD và danh sách use case bổ sung.
...
```text
BE1 owner Auth/User/Security
BE2 owner Academic/Notebook/Document/RAG
BE3 owner Quiz/Flashcard/Marketplace/Governance
```
...
| `entity/User`, `PasswordReset`, `Notification`, `SystemFeedback`, `SystemConfig` | BE1 | Auth/User/System group |
| `entity/Semester`, `Combo`, `Subject`, `Notebook`, `Document`, `DocumentChunk`, `Tag`, `ChatSession`, `ChatMessage` | BE2 | Academic/Document/RAG/Chat group |
| `entity/Quiz`, `Test`, `Flashcard`, `MarketReview`, `ContentReport`, `CommunityRole`, `Badge` | BE3 | Practice/Community/Governance group |
...
| Student | Ask AI in notebook | Chat/RAG | BE2 |
| Student | View chat history | Chat | BE2 |
...
| Reviewer | Review marketplace content | Marketplace/Governance | BE3 |
| Reviewer | Approve/reject content | Marketplace/Governance | BE3 |
| Admin | Manage master data | Academic/System | BE2/BE1 |
| Admin | Manage users | User | BE1 |
| Admin | Manage community roles | Community | BE3 |
...
|---|---|---|
| BE1 | Foundation, Auth, User, Security, Notification, System Feedback, System Config | Document/Quiz/Flashcard core service |
| BE2 | Academic, Notebook, Document, Tag, Chunk, Chat/RAG | SecurityConfig, Quiz/Test core |
| BE3 | Quiz, Test, Flashcard, Marketplace, Governance, Community Role, Badge | Auth/Security core, Document upload core |
...
- **Owner:** BE2
- **Labels:** `type:feature`, `priority:high`, `area:rag`, `area:document`, `owner:BE2`
- **Estimate:** 7h
- **Start:** 12/06/2026
- **Deadline:** 13/06/2026
- **Depends on:** BE-012
...
- [ ] Handle status `PROCESSING`, `SUCCESS`, `FAILED`
...
- **Owner:** BE2
- **Labels:** `type:feature`, `priority:critical`, `area:chat`, `owner:BE2`
- **Estimate:** 5h
- **Start:** 13/06/2026
- **Deadline:** 14/06/2026
- **Depends on:** BE-011
...
- **Owner:** BE2
- **Labels:** `type:feature`, `priority:critical`, `area:chat`, `area:rag`, `owner:BE2`
- **Estimate:** 8h
- **Start:** 14/06/2026
- **Deadline:** 15/06/2026
...
- [ ] Save user message
- [ ] Retrieve related chunks by notebook documents
- [ ] Mock AI answer from top chunks
- [ ] Save AI message
- [ ] Generate `citedSources` JSON
...
- [ ] Tạo repositories
- [ ] Start test from quiz
- [ ] Store status `IN_PROGRESS`
- [ ] Save selected option answer
- [ ] Save text answer
- [ ] Calculate `isCorrect` per answer
- [ ] Upsert answer nếu user đổi đáp án
- [ ] Check test owner

#### Acceptance Criteria

- [ ] Start test tạo test instance
- [ ] User answer từng câu được
- [ ] Đổi đáp án không tạo duplicate progress
- [ ] User không answer test của người khác
...
- **Owner:** BE3
- **Labels:** `type:feature`, `priority:medium`, `area:community`, `owner:BE3`
- **Estimate:** 7h
- **Start:** 19/06/2026
- **Deadline:** 20/06/2026
- **Depends on:** BE-003, BE-002
- **Branch:** `feature/community-roles`
...
- **Owner:** BE2
- **Labels:** `type:test`, `priority:high`, `owner:BE2`
- **Estimate:** 6h
- **Start:** 19/06/2026
- **Deadline:** 20/06/2026
...
| 09/06 | BE-004, BE-005 | BE-010 | BE-019, BE-020 |
| 10/06 | BE-006, BE-007 | BE-011 | BE-020 |
| 11/06 | BE-034 | BE-012, BE-013 | BE-021 |
| 12/06 | BE-035 | BE-014, BE-015, BE-016 | BE-022 |
| 13/06 | BE-036 | BE-016, BE-017 | BE-022, BE-023 |
| 14/06 | BE-037 | BE-018 | BE-024 |

## Tuần 2

| Ngày | BE1 | BE2 | BE3 |
|---|---|---|---|
| 15/06 | BE-037 fix/test | BE-018 fix/test | BE-024, BE-025 |
| 16/06 | Support integration | RAG chat integration | BE-026, BE-027 |
| 17/06 | Support auth/admin permission | Support marketplace query | BE-028, BE-030 |
| 18/06 | Support notification hook | Support document clone if needed | BE-029, BE-031 |
| 19/06 | BE-038 | BE-039 | BE-032 |
| 20/06 | BE-038, BE-040 | BE-039, BE-040 | BE-033, BE-040 |
| 21/06 | BE-040 final | BE-040 final | BE-040 final |
