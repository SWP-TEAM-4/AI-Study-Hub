...
public enum ErrorCode {
        ...
        EMAIL_NOT_VERIFIED("EMAIL_NOT_VERIFIED", "Please verify your email before logging in.",
                        HttpStatus.FORBIDDEN),
        ACCOUNT_ALREADY_VERIFIED("ACCOUNT_ALREADY_VERIFIED", "This account has already been verified.",
                        HttpStatus.CONFLICT),
        INVALID_VERIFICATION_CODE("INVALID_VERIFICATION_CODE", "Verification code is invalid.",
                        HttpStatus.BAD_REQUEST),
        VERIFICATION_CODE_EXPIRED("VERIFICATION_CODE_EXPIRED",
                        "Verification code has expired. Please request a new one.", HttpStatus.BAD_REQUEST),
        ...
        VERIFICATION_RESEND_TOO_SOON("VERIFICATION_RESEND_TOO_SOON",
                        "Please wait before requesting another verification code.", HttpStatus.TOO_MANY_REQUESTS),
        ACCOUNT_CREATION_IP_LIMIT_EXCEEDED("ACCOUNT_CREATION_IP_LIMIT_EXCEEDED",
                        "Too many accounts have been created from this IP address.", HttpStatus.TOO_MANY_REQUESTS),
        ...
        DOCUMENT_NOT_SAFE_FOR_DISTRIBUTION("DOCUMENT_NOT_SAFE_FOR_DISTRIBUTION",
                        "Document must be successfully chunked and safety-checked before this action.",
                        HttpStatus.CONFLICT),
        DOCUMENT_BLOCKED_BY_MODERATION("DOCUMENT_BLOCKED_BY_MODERATION",
                        "Document has been blocked by safety moderation.", HttpStatus.FORBIDDEN),
        ...
        GEMINI_RATE_LIMITED("GEMINI_RATE_LIMITED",
                        "Gemini is rate limited. Please wait and try again.", HttpStatus.TOO_MANY_REQUESTS),
