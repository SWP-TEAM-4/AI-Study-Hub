...
public class AdminSystemConfigController {
    ...
    public ResponseEntity<ApiResponse<SystemConfigResponse>> createConfig(
        ...
        SystemConfigResponse response = systemConfigService.create(request);
    ...
    public ResponseEntity<ApiResponse<SystemConfigResponse>> updateConfig(
        ...
        return ResponseEntity.ok(ApiResponse.success("Success", systemConfigService.update(id, request)));
    }

    @Operation(summary = "Admin xóa system config")
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<SystemConfigDeleteResponse>> deleteConfig(@PathVariable Long id) {
